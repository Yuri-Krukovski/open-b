...
public class ApiResponseOfIdentity {
  ...
  public ApiResponseOfIdentity() { 
  }

  public ApiResponseOfIdentity meta(ResponseMeta meta) {
  ...
  **/
  ...
  public ApiResponseOfIdentity data(Identity data) {
  ...
  **/
  ...
  public ApiResponseOfIdentity links(Map<String, String> links) {
    
    this.links = links;
    return this;
  }

  public ApiResponseOfIdentity putLinksItem(String key, String linksItem) {
    if (this.links == null) {
  ...
  **/
  ...
  public ApiResponseOfIdentity forwardedData(List<ResponseForwardedData> forwardedData) {
    
    this.forwardedData = forwardedData;
    return this;
  }

  public ApiResponseOfIdentity addForwardedDataItem(ResponseForwardedData forwardedDataItem) {
  ...
  **/
  ...
  public ApiResponseOfIdentity raw(List<RawResponse> raw) {
    
    this.raw = raw;
    return this;
  }

  public ApiResponseOfIdentity addRawItem(RawResponse rawItem) {
    if (this.raw == null) {
  ...
  **/
  ...
  public ApiResponseOfIdentity tracingId(String tracingId) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    ApiResponseOfIdentity apiResponseOfIdentity = (ApiResponseOfIdentity) o;
    return Objects.equals(this.meta, apiResponseOfIdentity.meta) &&
        Objects.equals(this.data, apiResponseOfIdentity.data) &&
        Objects.equals(this.links, apiResponseOfIdentity.links) &&
        Objects.equals(this.forwardedData, apiResponseOfIdentity.forwardedData) &&
        Objects.equals(this.raw, apiResponseOfIdentity.raw) &&
        Objects.equals(this.tracingId, apiResponseOfIdentity.tracingId);
  }
