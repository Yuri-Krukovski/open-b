...
public class ApiResponseOfBalances {
  ...
  public ApiResponseOfBalances() { 
  }

  public ApiResponseOfBalances meta(ResponseMeta meta) {
  ...
  **/
  ...
  public ApiResponseOfBalances data(Balances data) {
  ...
  **/
  ...
  public void setData(Balances data) {
    this.data = data;
  }


  public ApiResponseOfBalances links(Map<String, String> links) {
    
    this.links = links;
    return this;
  }

  public ApiResponseOfBalances putLinksItem(String key, String linksItem) {
    if (this.links == null) {
  ...
  **/
  ...
  public ApiResponseOfBalances forwardedData(List<ResponseForwardedData> forwardedData) {
    
    this.forwardedData = forwardedData;
    return this;
  }

  public ApiResponseOfBalances addForwardedDataItem(ResponseForwardedData forwardedDataItem) {
  ...
  **/
  ...
  public ApiResponseOfBalances raw(List<RawResponse> raw) {
    
    this.raw = raw;
    return this;
  }

  public ApiResponseOfBalances addRawItem(RawResponse rawItem) {
    if (this.raw == null) {
  ...
  **/
  ...
  public ApiResponseOfBalances tracingId(String tracingId) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    ApiResponseOfBalances apiResponseOfBalances = (ApiResponseOfBalances) o;
    return Objects.equals(this.meta, apiResponseOfBalances.meta) &&
        Objects.equals(this.data, apiResponseOfBalances.data) &&
        Objects.equals(this.links, apiResponseOfBalances.links) &&
        Objects.equals(this.forwardedData, apiResponseOfBalances.forwardedData) &&
        Objects.equals(this.raw, apiResponseOfBalances.raw) &&
        Objects.equals(this.tracingId, apiResponseOfBalances.tracingId);
  }
