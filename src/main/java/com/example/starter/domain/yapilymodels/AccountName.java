...
public class AccountName {
  ...
  public AccountName name(String name) {
  ...
  **/
  ...
  @ApiModelProperty(value = "The bank account holder's name given by the account owner.")
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.name, accountName.name);
  }
