...
public class FilteredClientPayloadListPaymentResponse {
  ...
  public FilteredClientPayloadListPaymentResponse() { 
  }

  public FilteredClientPayloadListPaymentResponse apiCall(Object apiCall) {
  ...
  **/
  ...
  public FilteredClientPayloadListPaymentResponse data(List<PaymentResponse> data) {
    
    this.data = data;
    return this;
  }

  public FilteredClientPayloadListPaymentResponse addDataItem(PaymentResponse dataItem) {
    if (this.data == null) {
  ...
  **/
  ...
  public FilteredClientPayloadListPaymentResponse nextCursorHash(String nextCursorHash) {
  ...
  **/
  ...
  public FilteredClientPayloadListPaymentResponse nextLink(String nextLink) {
  ...
  **/
  ...
  public FilteredClientPayloadListPaymentResponse pagingMap(Map<String, FilterAndSort> pagingMap) {
    
    this.pagingMap = pagingMap;
    return this;
  }

  public FilteredClientPayloadListPaymentResponse putPagingMapItem(String key, FilterAndSort pagingMapItem) {
  ...
  **/
  ...
  public FilteredClientPayloadListPaymentResponse totalCount(Long totalCount) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    FilteredClientPayloadListPaymentResponse filteredClientPayloadListPaymentResponse = (FilteredClientPayloadListPaymentResponse) o;
    return Objects.equals(this.apiCall, filteredClientPayloadListPaymentResponse.apiCall) &&
        Objects.equals(this.data, filteredClientPayloadListPaymentResponse.data) &&
        Objects.equals(this.nextCursorHash, filteredClientPayloadListPaymentResponse.nextCursorHash) &&
        Objects.equals(this.nextLink, filteredClientPayloadListPaymentResponse.nextLink) &&
        Objects.equals(this.pagingMap, filteredClientPayloadListPaymentResponse.pagingMap) &&
        Objects.equals(this.totalCount, filteredClientPayloadListPaymentResponse.totalCount);
  }
  ...
  public String toString() {
    ...
    sb.append("class FilteredClientPayloadListPaymentResponse {\n");
