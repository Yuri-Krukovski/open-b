...
public class FilteredClientPayloadListConsent {
  ...
  public FilteredClientPayloadListConsent() { 
  }

  public FilteredClientPayloadListConsent apiCall(Object apiCall) {
  ...
  **/
  ...
  public FilteredClientPayloadListConsent data(List<Consent> data) {
    
    this.data = data;
    return this;
  }

  public FilteredClientPayloadListConsent addDataItem(Consent dataItem) {
    if (this.data == null) {
  ...
  **/
  ...
  public FilteredClientPayloadListConsent nextCursorHash(String nextCursorHash) {
  ...
  **/
  ...
  public FilteredClientPayloadListConsent nextLink(String nextLink) {
  ...
  **/
  ...
  public FilteredClientPayloadListConsent pagingMap(Map<String, FilterAndSort> pagingMap) {
    
    this.pagingMap = pagingMap;
    return this;
  }

  public FilteredClientPayloadListConsent putPagingMapItem(String key, FilterAndSort pagingMapItem) {
  ...
  **/
  ...
  public FilteredClientPayloadListConsent totalCount(Long totalCount) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    FilteredClientPayloadListConsent filteredClientPayloadListConsent = (FilteredClientPayloadListConsent) o;
    return Objects.equals(this.apiCall, filteredClientPayloadListConsent.apiCall) &&
        Objects.equals(this.data, filteredClientPayloadListConsent.data) &&
        Objects.equals(this.nextCursorHash, filteredClientPayloadListConsent.nextCursorHash) &&
        Objects.equals(this.nextLink, filteredClientPayloadListConsent.nextLink) &&
        Objects.equals(this.pagingMap, filteredClientPayloadListConsent.pagingMap) &&
        Objects.equals(this.totalCount, filteredClientPayloadListConsent.totalCount);
  }
  ...
  public String toString() {
    ...
    sb.append("class FilteredClientPayloadListConsent {\n");
