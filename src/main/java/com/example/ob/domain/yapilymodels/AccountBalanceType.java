 ...
 */
@JsonAdapter(AccountBalanceType.Adapter.class)
public enum AccountBalanceType {
  ...
  public static class Adapter extends TypeAdapter<AccountBalanceType> {
    @Override
    public void write(final JsonWriter jsonWriter, final AccountBalanceType enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public AccountBalanceType read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return AccountBalanceType.fromValue(value);
    }
  }
}
