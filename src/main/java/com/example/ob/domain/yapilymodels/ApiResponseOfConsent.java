...
public class ApiResponseOfConsent {
  ...
  public ApiResponseOfConsent() { 
  }

  public ApiResponseOfConsent meta(ResponseMeta meta) {
  ...
  **/
  ...
  public ApiResponseOfConsent data(Consent data) {
  ...
  **/
  ...
  public ApiResponseOfConsent links(Map<String, String> links) {
    
    this.links = links;
    return this;
  }

  public ApiResponseOfConsent putLinksItem(String key, String linksItem) {
    if (this.links == null) {
  ...
  **/
  ...
  public ApiResponseOfConsent forwardedData(List<ResponseForwardedData> forwardedData) {
    
    this.forwardedData = forwardedData;
    return this;
  }

  public ApiResponseOfConsent addForwardedDataItem(ResponseForwardedData forwardedDataItem) {
  ...
  **/
  ...
  public ApiResponseOfConsent raw(List<RawResponse> raw) {
    
    this.raw = raw;
    return this;
  }

  public ApiResponseOfConsent addRawItem(RawResponse rawItem) {
    if (this.raw == null) {
  ...
  **/
  ...
  public ApiResponseOfConsent tracingId(String tracingId) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    ApiResponseOfConsent apiResponseOfConsent = (ApiResponseOfConsent) o;
    return Objects.equals(this.meta, apiResponseOfConsent.meta) &&
        Objects.equals(this.data, apiResponseOfConsent.data) &&
        Objects.equals(this.links, apiResponseOfConsent.links) &&
        Objects.equals(this.forwardedData, apiResponseOfConsent.forwardedData) &&
        Objects.equals(this.raw, apiResponseOfConsent.raw) &&
        Objects.equals(this.tracingId, apiResponseOfConsent.tracingId);
  }
