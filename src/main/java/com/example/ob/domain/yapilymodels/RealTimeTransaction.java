...
public class RealTimeTransaction {
  ...
  public RealTimeTransaction id(String id) {
  ...
  **/
  ...
  public RealTimeTransaction date(OffsetDateTime date) {
  ...
  **/
  ...
  public RealTimeTransaction bookingDateTime(OffsetDateTime bookingDateTime) {
  ...
  **/
  ...
  public RealTimeTransaction valueDateTime(OffsetDateTime valueDateTime) {
  ...
  **/
  ...
  public RealTimeTransaction status(TransactionStatusEnum status) {
  ...
  **/
  ...
  public RealTimeTransaction transactionAmount(Amount transactionAmount) {
  ...
  **/
  ...
  public RealTimeTransaction grossAmount(Amount grossAmount) {
  ...
  **/
  ...
  public RealTimeTransaction currencyExchange(CurrencyExchange currencyExchange) {
  ...
  **/
  ...
  public RealTimeTransaction chargeDetails(TransactionChargeDetails chargeDetails) {
  ...
  **/
  ...
  public RealTimeTransaction reference(String reference) {
  ...
  **/
  ...
  public RealTimeTransaction statementReferences(List<StatementReference> statementReferences) {
    
    this.statementReferences = statementReferences;
    return this;
  }

  public RealTimeTransaction addStatementReferencesItem(StatementReference statementReferencesItem) {
  ...
  **/
  ...
  public RealTimeTransaction description(String description) {
  ...
  **/
  ...
  public RealTimeTransaction transactionInformation(List<String> transactionInformation) {
    
    this.transactionInformation = transactionInformation;
    return this;
  }

  public RealTimeTransaction addTransactionInformationItem(String transactionInformationItem) {
  ...
  **/
  ...
  public RealTimeTransaction addressDetails(AddressDetails addressDetails) {
  ...
  **/
  ...
  public RealTimeTransaction isoBankTransactionCode(IsoBankTransactionCode isoBankTransactionCode) {
  ...
  **/
  ...
  public RealTimeTransaction proprietaryBankTransactionCode(ProprietaryBankTransactionCode proprietaryBankTransactionCode) {
  ...
  **/
  ...
  public RealTimeTransaction balance(TransactionBalance balance) {
  ...
  **/
  ...
  public RealTimeTransaction payeeDetails(Payee payeeDetails) {
  ...
  **/
  ...
  public RealTimeTransaction payerDetails(Payer payerDetails) {
  ...
  **/
  ...
  public RealTimeTransaction merchant(Merchant merchant) {
  ...
  **/
  ...
  public RealTimeTransaction supplementaryData(Object supplementaryData) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    RealTimeTransaction realTimeTransaction = (RealTimeTransaction) o;
    return Objects.equals(this.id, realTimeTransaction.id) &&
        Objects.equals(this.date, realTimeTransaction.date) &&
        Objects.equals(this.bookingDateTime, realTimeTransaction.bookingDateTime) &&
        Objects.equals(this.valueDateTime, realTimeTransaction.valueDateTime) &&
        Objects.equals(this.status, realTimeTransaction.status) &&
        Objects.equals(this.transactionAmount, realTimeTransaction.transactionAmount) &&
        Objects.equals(this.grossAmount, realTimeTransaction.grossAmount) &&
        Objects.equals(this.currencyExchange, realTimeTransaction.currencyExchange) &&
        Objects.equals(this.chargeDetails, realTimeTransaction.chargeDetails) &&
        Objects.equals(this.reference, realTimeTransaction.reference) &&
        Objects.equals(this.statementReferences, realTimeTransaction.statementReferences) &&
        Objects.equals(this.description, realTimeTransaction.description) &&
        Objects.equals(this.transactionInformation, realTimeTransaction.transactionInformation) &&
        Objects.equals(this.addressDetails, realTimeTransaction.addressDetails) &&
        Objects.equals(this.isoBankTransactionCode, realTimeTransaction.isoBankTransactionCode) &&
        Objects.equals(this.proprietaryBankTransactionCode, realTimeTransaction.proprietaryBankTransactionCode) &&
        Objects.equals(this.balance, realTimeTransaction.balance) &&
        Objects.equals(this.payeeDetails, realTimeTransaction.payeeDetails) &&
        Objects.equals(this.payerDetails, realTimeTransaction.payerDetails) &&
        Objects.equals(this.merchant, realTimeTransaction.merchant) &&
        Objects.equals(this.supplementaryData, realTimeTransaction.supplementaryData);
  }

  @Override
  public int hashCode() {
    return Objects.hash(id, date, bookingDateTime, valueDateTime, status, transactionAmount, grossAmount, currencyExchange, chargeDetails, reference, statementReferences, description, transactionInformation, addressDetails, isoBankTransactionCode, proprietaryBankTransactionCode, balance, payeeDetails, payerDetails, merchant, supplementaryData);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class RealTimeTransaction {\n");
