...
public class FilteredClientPayloadListInstitution {
  ...
  public FilteredClientPayloadListInstitution() { 
  }

  public FilteredClientPayloadListInstitution apiCall(Object apiCall) {
  ...
  **/
  ...
  public FilteredClientPayloadListInstitution data(List<Institution> data) {
    
    this.data = data;
    return this;
  }

  public FilteredClientPayloadListInstitution addDataItem(Institution dataItem) {
    if (this.data == null) {
  ...
  **/
  ...
  public FilteredClientPayloadListInstitution nextCursorHash(String nextCursorHash) {
  ...
  **/
  ...
  public FilteredClientPayloadListInstitution nextLink(String nextLink) {
  ...
  **/
  ...
  public FilteredClientPayloadListInstitution pagingMap(Map<String, FilterAndSort> pagingMap) {
    
    this.pagingMap = pagingMap;
    return this;
  }

  public FilteredClientPayloadListInstitution putPagingMapItem(String key, FilterAndSort pagingMapItem) {
  ...
  **/
  ...
  public FilteredClientPayloadListInstitution totalCount(Long totalCount) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    FilteredClientPayloadListInstitution filteredClientPayloadListInstitution = (FilteredClientPayloadListInstitution) o;
    return Objects.equals(this.apiCall, filteredClientPayloadListInstitution.apiCall) &&
        Objects.equals(this.data, filteredClientPayloadListInstitution.data) &&
        Objects.equals(this.nextCursorHash, filteredClientPayloadListInstitution.nextCursorHash) &&
        Objects.equals(this.nextLink, filteredClientPayloadListInstitution.nextLink) &&
        Objects.equals(this.pagingMap, filteredClientPayloadListInstitution.pagingMap) &&
        Objects.equals(this.totalCount, filteredClientPayloadListInstitution.totalCount);
  }
  ...
  public String toString() {
    ...
    sb.append("class FilteredClientPayloadListInstitution {\n");
