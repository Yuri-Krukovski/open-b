...
public class TransactionStream {
  ...
  public TransactionStream name(String name) {
  ...
  **/
  ...
  public TransactionStream transactions(List<EnrichedTransaction> transactions) {
    
    this.transactions = transactions;
    return this;
  }

  public TransactionStream addTransactionsItem(EnrichedTransaction transactionsItem) {
  ...
  **/
  ...
  public TransactionStream transactionSchedule(TransactionSchedule transactionSchedule) {
  ...
  **/
  ...
  public TransactionStream scheduleConsistencyScore(BigDecimal scheduleConsistencyScore) {
  ...
  **/
  ...
  public TransactionStream nextExpectedTransactionDate(LocalDate nextExpectedTransactionDate) {
  ...
  **/
  ...
  public TransactionStream earliestTransactionDate(LocalDate earliestTransactionDate) {
  ...
  **/
  ...
  public TransactionStream mostRecentTransactionDate(LocalDate mostRecentTransactionDate) {
  ...
  **/
  ...
  public TransactionStream amountConsistencyScore(BigDecimal amountConsistencyScore) {
  ...
  **/
  ...
  public TransactionStream averageAmount(BigDecimal averageAmount) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.name, transactionStream.name) &&
        Objects.equals(this.transactions, transactionStream.transactions) &&
        Objects.equals(this.transactionSchedule, transactionStream.transactionSchedule) &&
        Objects.equals(this.scheduleConsistencyScore, transactionStream.scheduleConsistencyScore) &&
        Objects.equals(this.nextExpectedTransactionDate, transactionStream.nextExpectedTransactionDate) &&
        Objects.equals(this.earliestTransactionDate, transactionStream.earliestTransactionDate) &&
        Objects.equals(this.mostRecentTransactionDate, transactionStream.mostRecentTransactionDate) &&
        Objects.equals(this.amountConsistencyScore, transactionStream.amountConsistencyScore) &&
        Objects.equals(this.averageAmount, transactionStream.averageAmount);
  }

  @Override
  public int hashCode() {
    return Objects.hash(name, transactions, transactionSchedule, scheduleConsistencyScore, nextExpectedTransactionDate, earliestTransactionDate, mostRecentTransactionDate, amountConsistencyScore, averageAmount);
  }
