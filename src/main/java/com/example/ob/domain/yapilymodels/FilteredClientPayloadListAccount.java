...
public class FilteredClientPayloadListAccount {
  ...
  public FilteredClientPayloadListAccount() { 
  }

  public FilteredClientPayloadListAccount apiCall(Object apiCall) {
  ...
  **/
  ...
  public FilteredClientPayloadListAccount data(List<Account> data) {
    
    this.data = data;
    return this;
  }

  public FilteredClientPayloadListAccount addDataItem(Account dataItem) {
    if (this.data == null) {
  ...
  **/
  ...
  public FilteredClientPayloadListAccount nextCursorHash(String nextCursorHash) {
  ...
  **/
  ...
  public FilteredClientPayloadListAccount nextLink(String nextLink) {
  ...
  **/
  ...
  public FilteredClientPayloadListAccount pagingMap(Map<String, FilterAndSort> pagingMap) {
    
    this.pagingMap = pagingMap;
    return this;
  }

  public FilteredClientPayloadListAccount putPagingMapItem(String key, FilterAndSort pagingMapItem) {
  ...
  **/
  ...
  public FilteredClientPayloadListAccount totalCount(Long totalCount) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    FilteredClientPayloadListAccount filteredClientPayloadListAccount = (FilteredClientPayloadListAccount) o;
    return Objects.equals(this.apiCall, filteredClientPayloadListAccount.apiCall) &&
        Objects.equals(this.data, filteredClientPayloadListAccount.data) &&
        Objects.equals(this.nextCursorHash, filteredClientPayloadListAccount.nextCursorHash) &&
        Objects.equals(this.nextLink, filteredClientPayloadListAccount.nextLink) &&
        Objects.equals(this.pagingMap, filteredClientPayloadListAccount.pagingMap) &&
        Objects.equals(this.totalCount, filteredClientPayloadListAccount.totalCount);
  }
  ...
  public String toString() {
    ...
    sb.append("class FilteredClientPayloadListAccount {\n");
